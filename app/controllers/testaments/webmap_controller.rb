class Testaments::WebmapController < TestamentsBaseController
  layout "webmap"
...
# We are going return two types, Routes and Active VehicleJourneys.
 ...
 def getRouteDefinitionJSON(route)
   ...
   data[:_geoJSONUrl]= route_testament_webmap_path(:ref => route.persistentid, :format => :json)
 ...
 def getJourneyDefinitionJSON(journey)
   ...
   data[:_geoJSONUrl]= journey_testament_webmap_path(:ref => journey.persistentid, :format => :json)
