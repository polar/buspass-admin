class Masters::Deployments::Networks::WebmapController < Masters::Deployments::Networks::NetworkBaseController
 ...
 def getRouteDefinitionJSON(route)
   ...
   data[:_geoJSONUrl]= route_master_deployment_network_webmap_path(@master, @deployment, @network, :ref => route.id, :format => :json)
