...
(function($, undefined) {
    ...
    $.fn.clock = function(options) {
        ...
        return this.each(function(){
            ...
            options.starting_timestamp = systimestamp;
            options.sysdiff = 0;
            ...
            var addleadingzero = function(i){
                ...
                updateClock = function(el,myoptions) {
                    ...
                    if(myoptions=="destroy"){ clearTimeout(t[el_id]); }
                        ...
                        var mult = myoptions['mult'] || 1;
                        mytimestamp = new Date();
                        mytimestamp = mytimestamp.getTime();
                        if (myoptions.mult != 1) {
                            mytimestamp = myoptions.starting_timestamp + myoptions.sysdiff + (mytimestamp - myoptions.starting_timestamp) * mult;
                        } else {
